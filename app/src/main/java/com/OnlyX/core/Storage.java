...
public class Storage {
    ...
    public static DocumentFile initRoot(Context context, String uri) {
        if (uri == null) {
            File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath(), "OnlyX");
    ...
    private static boolean isDirSame(DocumentFile root, DocumentFile dst) {
        return root.getUri().getScheme().equals("file") && dst.getUri().getPath().endsWith("primary:OnlyX") ||
