...
public class IKanman extends MangaParser {
    ...
    private final String baseUrl = "https://www.mhgui.com/";
    ...
    public Request getSearchRequest(String keyword, int page) {
        String url;
        if (page == 1)
            url = StringUtils.format(baseUrl + "s/%s.html", keyword);
        else
            url = StringUtils.format(baseUrl + "s/%s_p%d.html", keyword, page);
        return new Request.Builder().url(url).headers(Headers.of(getHeader())).build();
    }
    ...
    public SearchIterator getSearchIterator(String html, int page) {
        ...
        return new NodeIterator(body.list("li.cf")) {
            ...
            protected Comic parse(Node node) {
                ...
                String cover = "https:" + node.attr("a.bcover > img", "src");
                String author = node.text(".book-detail > dl > dd.tags:eq(3)");
                String update = node.text(".book-detail > dl > dd.tags.status :eq(3)");
    ...
    protected void initUrlFilterList() {
        ...
        filter.add(new UrlFilter("tw.mhgui.com"));
    ...
    public Request getInfoRequest(String cid) {
        String url = baseUrl + "comic/".concat(cid).concat("/");
        return new Request.Builder().url(url).headers(Headers.of(getHeader())).build();
    }
    ...
    public void parseInfo(String html, Comic comic) {
        ...
        String cover = "https:" + body.src("p.hcover > img");
    ...
    public Request getImagesRequest(String cid, String path) {
        String url = StringUtils.format(baseUrl + "comic/%s/%s.html", cid, path);
        return new Request.Builder().url(url).headers(Headers.of(getHeader())).build();
    }
